...
export const BasicDetails: React.FC = () => {
  ...
  const internalOrderNumbers = [
   ...
   const handleNextClick = () =>{
      navigate('/create-billing/resourceGroup');
   }
  return (
   ...
   <div className="flex">
      ...
      <div className="flex-1 p-6 bg-white w-full">
         ...
         <div className="flex justify-end gap-3">
            ...
            <button onClick={handleNextClick} className="px-6 py-2 bg-blue-500 text-white rounded-md text-sm font-medium hover:bg-blue-600">
            Continue
            </button>
         </div>
      </div>
